...
const Hero = () => (
  <div className="text-center hero">
   ...
   <p className="paragraph"> Once complete with verification, create or link your account using the login button found in the menu at the top right of the page.</p>
